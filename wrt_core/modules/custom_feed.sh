...
install_custom_feed() {
    ...
    local required_feed_dirs=(
        cups tcping v2ray-geodata geo2txt luci-lib-taskd luci-app-openclash
    ...
    custom_feed_sources=(
        ...
        "sbwml/luci-app-mosdns|https://github.com/sbwml/luci-app-mosdns.git|v5|mosdns geo2txt luci-app-mosdns"
