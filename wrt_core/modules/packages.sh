...
remove_unwanted_packages() {
    local luci_packages=(
        ...
        "luci-app-haproxy-tcp" "luci-app-openclash" "luci-app-appfilter"
    ...
    local packages_net=(
        ...
        "dae" "daed" "geoview" "tailscale" "open-app-filter" "msd_lite"
    )
...
update_smartdns() {
    local SMARTDNS_REPO="https://github.com/fanqisoft/openwrt-smartdns.git"
